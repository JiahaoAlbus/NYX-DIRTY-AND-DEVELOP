    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <section className="p-4 rounded-xl bg-white border border-primary/20 shadow-sm">
          ...
          <div className="text-xs text-text-subtle leading-relaxed">
            NYX is a deterministic, verifiable portal infrastructure. This is a Testnet Portal v1 preview. All state
            transitions generate evidence that can be replayed for correctness.
          </div>
        </section>
      </div>
    </div>
