...
## Purpose
This directory contains materials related to funding, grants, and strategic partnerships for the NYX project.

**Disclaimer**: Nothing in this directory constitutes an offer to sell securities or legal advice.

## Contents

-   **[Investor One-Pager](./INVESTOR_ONE_PAGER.md)**: Factual summary for potential backers.
...
-   **Focus**: Technology validation, determinism, portal infrastructure.
-   **Token**: None (Testnet only).
